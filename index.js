...
function buildEmailHtml(dateISO, picks, articles) {
  ...
  const articlesHtml = articles.map(a => {
    ...
    return `<li style="margin-bottom: 12px; line-height: 1.6; text-align: left;">
      <a href="${a.link}" style="color: ${brandColor}; text-decoration: none; font-weight: 600;">
        ${escapeHtml(a.title)}
      </a> 
      — <em style="color: #666;">${escapeHtml(a.source)}</em>
      <div style="margin-top: 6px; color: #555; font-size: 13px; text-align: left;">
        ${e
